...
#   make install	  - Installs the application on the local system.
...
help:
	...
	@echo ""
	@echo -e "${BRIGHT_WHITE}make install:${NC}"
	@echo -e "  Install the application on the local system."
	@echo -e "    Installs the 'powerpr' application on the local system, making it available"
	@echo -e "    for use in any directory without needing to specify the full path."
	@echo ""
...
.PHONY: all build test docker-build docker-run help run install
